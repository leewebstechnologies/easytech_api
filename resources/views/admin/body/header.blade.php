                        ...
                        <ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center">
                                    ...
                                    <div class="noti-scroll" data-simplebar>
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item text-muted link-primary active">
                                            <div class="notify-icon">
                                                <img src="{{ asset('backend/assets/images/users/user-12.jpg') }}" class="img-fluid rounded-circle" alt="user12" />
                                            </div>
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item text-muted link-primary">
                                            <div class="notify-icon">
                                                <img src="{{ asset('backend/assets/images/users/user-2.jpg') }}" class="img-fluid rounded-circle" alt="user2" />
                                            </div>
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item text-muted link-primary">
                                            <div class="notify-icon">
                                                <img src="{{ asset('backend/assets/images/users/user-3.jpg') }}" class="img-fluid rounded-circle" alt="user3" />
                                            </div>
                                            <div class="notify-content">
                                                <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item text-muted link-primary">
                                            <div class="notify-icon">
                                                <img src="{{ asset('backend/') }}assets/images/users/user-8.jpg" class="img-fluid rounded-circle" alt="user8" />
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between">
                            ...
                            <li class="dropdown notification-list topbar-dropdown">
                                <a class="nav-link dropdown-toggle nav-user me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                    <img src="{{ (!empty($profileData->image)) ? url('upload/user_images/'.$profileData->image) : url('upload/no_image.jpg') }}" alt="user-image" class="rounded-circle">
