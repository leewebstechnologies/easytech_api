                    ...
                    <div class="card-body">
                        <form action="{{ route('update.site.setting') }}" method="post" class="row g-3" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" name="address" placeholder="Required example textarea">{{ $site->address }}</textarea>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="linkedin" class="form-control" value="{{ $site->linkedin }}">
                            </div>

                            <div class="col-md-6">
                                <label for="validationDefault01" class="form-label">Twitter</label>
                                <input type="text" name="twitter" class="form-control" value="{{ $site->twitter }}">
                            </div>

                            <div class="col-md-6">
                                <label for="validationDefault01" class="form-label">Instagram</label>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" name="footer_message" placeholder="Required example textarea">{{ $site->footer_message }}</textarea>
                            </div>
