                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('update.gateway.one') }}" method="post" class="row g-3" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="title" class="form-control" value="{{ $gateone->title }}">
                                            </div>

                                            <div class="col-md-6">
                                                <label for="validationDefault01" class="form-label">Phone</label>
                                                <input type="text" name="phone" class="form-control" value="{{ $gateone->phone }}">
                                            </div>

                                            <div class="col-md-12">
                                                <label for="validationDefault01" class="form-label">Description</label>
                                                <textarea class="form-control" name="description" placeholder="Required example textarea">{{ $gateone->description }}</textarea>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                 <img id="showImage" src="{{ asset($gateone->image) }}" class="rounded-circle avatar-xxl img-thumbnail float-start" alt="image profile">
                                            </div>
