                    ...
                    <div class="container-xxl">
                        ...
                        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                            <div class="flex-grow-1">
                                <h4 class="fs-18 fw-semibold m-0">Add Services</h4>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Add Services</h5>
                                    </div><!-- end card header -->

                                    <div class="card-body">
                                        <form id="myForm" action="{{ route('store.services') }}" method="post" class="row g-3" enctype="multipart/form-data">
                                            @csrf
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" name="services_short" placeholder="Add Services Short Description"></textarea>
                                            </div>
