            ...
            <div class="container-xxl">
                ...
                <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold m-0">All Blog Categories</h4>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="myForm" action="{{ route('store.blog.category') }}" method="post" class="row g-3">
                            @csrf
                            <div class="col-md-12">
    ...
    <div class="modal fade" id="category" tabindex="-1" aria-labelledby="standard-modalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="myForm" action="{{ route('update.blog.category') }}" method="post" class="row g-3">
                            @csrf
